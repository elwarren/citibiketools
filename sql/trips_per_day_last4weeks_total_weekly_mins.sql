...
-- %%		%
--
-- woy         mon         tue         wed         thu         fri         sat         sun         minPerWeek
-- ----------  ----------  ----------  ----------  ----------  ----------  ----------  ----------  ----------
-- 30          1           2           2           2           2           6                       36        
-- 31          2           2           2           2           3                       1           33        
-- 32          2           1           1           2           1           10                      46        
...
.headers on
.mode column
select woy, max(mon) mon, max(tue) tue, max(wed) wed, max(thu) thu, max(fri) fri, max(sat) sat, max(sun) sun, sum(durationSeconds)/60 minPerWeek
  from (
